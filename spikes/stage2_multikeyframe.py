...
# strongly. HARD pans left-basket (600) -> center (900) -> right side (1200).
...
EXCLUDE_REGIONS = [
    (7.5, 891.0, 327.0, 1063.5),   # HARD scorebug (bottom-left), from Stage 1
]
RATIO_TEST = 0.75
